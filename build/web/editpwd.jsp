            ...
            <div  class="row">
                <div class="col-md-6"  style=" left: 400px">
                    <div class="contact_form" >
                        ...
                        <p>Remember your password and change it time to time.</p>
                    </div><!-- end title -->
                    <div id="message" ></div>
                    <form method="post" name="f1" action="editpwd2.jsp"  onsubmit="return check(f1)" novalidate="novalidate">
							<div class="row" >
								<div   class="col-md-6" >
									<div style="  left: 175px " class="form-group">
                                                                            <input class="form-control" name="Text1" type="text" id="a"  placeholder="Old Password" required="required" data-validation-required-message="Please enter your old password.">
										<span class="help-block text-danger" id="d1"></span>
									</div>
									
									<div class="form-group" style=" left: 175px">
                                                                            
                                                                            <input  class="form-control" id="b" name="Text2" type="password"  placeholder="New Password" required="required" data-validation-required-message="Please enter new Password.">
										<span class="help-block text-danger" id="d2"></span>
									</div>
                                                                    <div class="form-group" style=" left: 175px">
                                                                            
                                                                            <input  class="form-control" id="c" name="Text3" type="password"  placeholder="Confirm Password" required="required" data-validation-required-message="Please enter new Password again.">
