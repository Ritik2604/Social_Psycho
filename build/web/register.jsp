...
<body id="page-top" class="politics_version">
	...
	<section id="home" class="main-banner parallaxie" style="background: url('uploads/banner-01.jpg')">
            ...
            <div class="row">
                ...
                <h3>Register</h3>
                <p>Your Journey starts from here and get your account and make new friends.</p>
            </div><!-- end title -->
                        <div id="message"></div>
                        <form action="reg.jsp" method="post"  name="f1" onsubmit="return check(f1)" novalidate="novalidate">
							<div class="row">
								<div class="col-md-6">
                                                                    <%
                            try{
                        ...
                        %>	
									<div class="form-group">
										<input name="Text1" type="text"    value="<%=id%>" class="form-control" id="name" readonly placeholder="Your UserId" required="required" data-validation-required-message="Please enter your ID.">
										<p class="help-block text-danger"></p>
									</div>
									<div class="form-group">
										<input name="Password1" id="b" type="password"  class="form-control"   placeholder="Your Password" required="required" data-validation-required-message="Please enter your Password.">
                                                                                <span class="help-block text-danger" id="d2"></span>
									</div>
									
									<div class="form-group">
                                                                                
                                                                            <select required="required" id="name" data-validation-required-message="Select  your Sequrity ques." class="form-control" name="Select1"style="height: 50px" >
                                                                                <option disabled> Security Ques</option>
                                                                                    <option selected >What is your pets name?</option>
								...
								<div class="col-md-6">
									<div class="form-group">
                                                                            <input name="Radio1" type="radio" checked   style="width: 50px;height:20px;"   value="male"> <span  style="color: black">MALE</span>
                                                                            <input name="Radio1" type="radio" style="width: 50px;height:20px;" value="female" ><span  style="color: black">FEMALE</span>
                                                                            <br>
                                                                            <input name="Text3" type="text"  placeholder="Security Answer"  class="form-control"  id="a" >
								...
								<div class="col-lg-12 text-center">
									<div id="success"></div>
                                                                        <button name="Submit1" class="sim-btn hvr-bounce-to-top" type="submit">Register</button>
                                                                        <%			
