...
<html lang="en">
    ...
    <script type="text/javascript">
            function check(f) {
                ...
                if (nm == "") 
                {
                    e1.innerHTML="Message field cant be empty";
                    flag = false;
                }
                else
                {
    ...
    <div id="horoscope" class="section wb">
		...
		<div class="container">
			<div class="section-title text-center">
				<h3>Send Message</h3>
				<p>Write a message to convey your feelings and whats going in your mind.</p>
			</div><!-- end title -->
...
%>
<form  action="messagesend2.jsp" name="f1" onsubmit="return check(f1)" method="post" novalidate="novalidate">
							<div class="row">
								<div class="col-md-6">
									<div class="form-group" style="left:200px">
                                                                            <textarea  name="TextArea1"class="form-control" id="a" placeholder="Your Message" required="required" data-validation-required-message="Please enter a message."></textarea>
								...
								<div class="col-lg-12 text-center">									                                                                       
                                                                    <input  class="sim-btn hvr-bounce-to-top" type="submit" value="Send">
                                                                                                        <button  class="sim-btn hvr-bounce-to-top" type="submit"><a href="viewfrdlst.jsp#team" style=" color: white">Back</a></button>
								</div>
							</div>
						</form>
