    ...
    <![endif]-->
     <script type="text/javascript">
            function check(f) {
                ...
                if (nm == "") 
                {
                    e1.innerHTML="Group name field cant be empty";
                    flag = false;
                }
                else
                {
...
<body id="page-top" class="politics_version">
	...
	<div id="groups" class="section lb">
            <div class="container">
			<div class="section-title text-center">
				<h3>View Blogs</h3>
...
<%
    try{
        ...
        ResultSet rs=new DB().execute("select topicid,topicdesc,topicusrid,topicdate,topictime from tbtopic where topicgid= "+gid);
        if(!rs.next()){
        %>
                                       <div class="section-title text-center">
                                                                                                           <br><br><br><br><br><h3 >No Blogs Found</h3><br><br><br><br><br>
...
<%                                        }else{ 
                            ...
                            %>
                                        <div class="col-md-4 col-sm-6 col-lg-4">
					<div class="post-box">
					   <a href="blogdetails.jsp?tid=<%=rs.getString("topicid")%>#groups">
	
                                            <div class="post-thumb">
                                                        <img src="images/blog.jpg" class="img-fluid" alt="post-img" />
							<div class="date">
								<span>By:</span>
								<span><%=rs.getString("topicusrid")%></span>
							</div>
                                            </div></a>
						<div class="post-info">
							<h4><%=rs.getString("topicdesc")%></h4>
							<ul>
                                <li></li>
                                <li>Created: &nbsp;<%=rs.getString("topictime")%></li>
                                <li>&nbsp;&nbsp; <%=rs.getString("topicdate")%></li>
                            </ul>
							<p></p>
						</div>
					</div>
