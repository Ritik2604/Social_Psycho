...
<body id="page-top" class="politics_version">
    ...
    ResultSet rs=new DB().execute("select usrgen from tbuser where userid='"+id+"'and usrpwd='"+oldps+"'");
if(rs.next()){
...
%>
			<h1>Password changed Successfully</h1>
                        ...
                        <div class="btn-ber">
					<a class="get_btn hvr-bounce-to-top" href="home.jsp">Home</a>
...
%>
			<h1>Old Password does not Match</h1>
				...
				<div class="btn-ber">
					<a class="get_btn hvr-bounce-to-top" href="home.jsp">Home</a>
					<a class="learn_btn hvr-bounce-to-top" href="editpwd.jsp">Try Again</a>
				</div>			
			</h3>
                         <%
