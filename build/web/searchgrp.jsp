...
<body id="page-top" class="politics_version">
	...
	<div id="groups" class="section lb">
        ...
        String uid=(String)session.getAttribute("uid");
            ...
            ResultSet rs=new DB().execute("select *from tbgroup  ");
              while(rs.next()){
                  ...
                  ResultSet rs1=new DB().execute("select memberuserid from tbgroupmember where membergid="+gid+" and memberuserid="+session.getAttribute("uid"));
           
                if(rs.getString("groupowner").equals(uid)){
                    %>
				
                    <h2 style="left:40%"><%=rs.getString("groupdesc")%></h2>
                                                <p style="left: 30%">You are group owner</p>
                                   ...
                                   <h2 style="left:40%"><%=rs.getString("groupdesc")%></h2>
                                  <p style=" left: 30%">Already Joined</p>
                                         <%
    ...
    %>       
                                     <h2 style="left:40%"><%=rs.getString("groupdesc")%></h2>
                                     <p style="  left: 40%"><a href="joingrp?gid=<%=rs.getString("groupid")%>" class="sim-btn">
                                         Join</a></p>
                                           <%    }   %>
