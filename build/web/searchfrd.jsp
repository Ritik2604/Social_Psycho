...
<body id="page-top" class="politics_version">
    ...
    <div id="horoscope" class="section wb">
		...
		<div class="container">
            ...
            int i=0;
            try{
        ResultSet rs =new DB().execute("select usrname,userid,usrimg from tbuser where userid!='"+session.getAttribute("uid")+"'");
        if(!rs.next()){
        %>
				 <div class="section-title text-center">
        ...
        do{
				...
				<div class="col-md-3 col-sm-6">
					<div class="friend">
						<div class="pic">
                                                    <a href="viewprf.jsp?id=<%=rs.getString("userid")%>&img=<%=rs.getString("usrimg")%>#team">
                                                        <img src="<%=rs.getString("usrimg")%>"></a>
						</div>
						<div class="team-content">
							<h3 class="title"> <a href="viewprf.jsp?id=<%=rs.getString("userid")%>&img=<%=rs.getString("usrimg")%>#team">
