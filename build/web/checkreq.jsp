x<%@page import="java.sql.ResultSet"%>
...
<body id="page-top" class="politics_version">
    ...
    <div id="horoscope" class="section wb">
		...
		<div class="container">
			...
			<%
            try{
        ResultSet rs =new DB().execute("select b.usrname,a.sno,a.userid,b.usrimg from tbfriend a,tbuser b where a.fid='"+session.getAttribute("uid")+"'and a.status=0 and a.userid=b.userid");
        if(!rs.next()){
        %>
         <div class="section-title text-center" style=" text-align: center; left:350px">
             <br><br><br><br><br><h3>No Requests are there</h3><br><br><br><br><br>
        ...
        do{
				...
				<div class="col-md-3 col-sm-6">
					<div class="our-team">
						<div class="pic">
                                                    <a href="checkreq2.jsp?fid=<%=rs.getString("userid")%>&sno=<%=rs.getString("sno")%>&img=<%=rs.getString("usrimg")%>#team">
                                                        <img src="<%=rs.getString("usrimg")%>"></a>
						</div>
						<div class="team-content">
							<h3 class="title"> <a href="checkreq2.jsp?fid=<%=rs.getString("userid")%>&sno=<%=rs.getString("sno")%>&img=<%=rs.getString("usrimg")%>#team">
                                                                <%=rs.getString("userid")%>&nbsp;&nbsp; <%=rs.getString("usrname")%></a></h3>
