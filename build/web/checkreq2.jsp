                    ...
                    <div class="contact_form">
                        <div id="message"></div>
                          <%
                            ...
                            ResultSet rs = new DB().execute("select ifnull(usrname,'')usrname,ifnull(usradd,'')usradd,ifnull(usrmob,'')usrmob,ifnull(usrqualification,'')usrqualification,ifnull(usrinterest,'')usrinterest,ifnull(usrdob,'')usrdob from tbuser where userid='" +request.getParameter("fid") + "'");
                            if (rs.next()) {
                                                                                        %>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<input class="form-control" id="name" type="text" placeholder="Your Name" value="<%=rs.getString("usrname")%>" readonly required="required" data-validation-required-message="Please enter your name.">
									</div>
									<div class="form-group">
                                                                            <input class="form-control" id="email" type="text" value="<%=rs.getString("usradd")%>" readonly placeholder="<%=rs.getString("usrname")%>'s Address" required="required" data-validation-required-message="Please enter your email address.">
									</div>
									<div class="form-group">
                                                                            <input class="form-control" id="phone" type="text" value="<%=rs.getString("usrmob")%>" readonly placeholder="<%=rs.getString("usrname")%>'s Phone" required="required" data-validation-required-message="Please enter your phone number.">
									</div>
                                                                                <div class="form-group">
                                                                            <input class="form-control" id="phone" type="text" value="<%=rs.getString("usrqualification")%>" readonly placeholder="<%=rs.getString("usrname")%>'s Qualification" required="required" data-validation-required-message="Please enter your phone number.">
									</div>
								...
								<div class="col-md-6">
									<div class="form-group">
                                                                             <div class="form-group">
                                                                            <input class="form-control" id="phone" type="text" value="<%=rs.getString("usrinterest")%>" readonly placeholder="<%=rs.getString("usrname")%>'s Interest" required="required" data-validation-required-message="Please enter your phone number.">
									</div>
                                                                                  <div class="form-group">
                                                                            <input class="form-control" id="phone" type="text" value="<%=rs.getString("usrdob")%>" readonly  placeholder="<%=rs.getString("usrname")%>'s DOB" required="required" data-validation-required-message="Please enter your phone number.">
									</div>
                                                                                </div>
                                                                                <div class="col-md-6">
                                                                                    <div class="right-box-pro wow fadeIn">
								...
								<div class="col-lg-12 text-center">
									...
									<button  class="sim-btn hvr-bounce-to-top" type="submit">
                                                                         <a href="accept?fid=<%=fid%>&sno=<%=request.getParameter("sno")%>" style="color:white">
                                                                             Accept</a>
                                                                       
                                                                            </button>
                                                                             <button  class="sim-btn hvr-bounce-to-top" type="submit">
                                                                                 <a href="reject?sno=<%=request.getParameter("sno")%>"  style=" color:white">Reject</a>                                                                       
                                                                        </button>
								</div>
							</div>
						</form>
