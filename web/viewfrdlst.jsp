    ...
    <div id="horoscope" class="section wb">
		...
		<div class="container">
			...
			<div class="row">
                              <% 
                                                                                                try {
                                                                                                    ResultSet rs = new DB().execute("select a.usrname,a.usrimg,b.fid from tbuser a,tbfriend b where a.userid=b.fid and status=1 and b.userid='" + (String) session.getAttribute("uid") + "'");
                                                                                                   ...
                                                                                                   if(!rs.next()){
                                                                                                       ...
                                                                                                       %>
                                                                                                       <div class="section-title text-center">
                                                                                                           <br><br><br><br><br><h3 >No Friends Found</h3><br><br><br><br><br>
            ...
            <%                                                               }else{ 
				...
				<div class="col-md-3 col-sm-6">
					<div class="our-team">
						<div class="pic">
                                                    <a href="messagesend.jsp?fid=<%=rs.getString("fid")%>#team">
                                                        <img src="<%=rs.getString("usrimg")%>"></a>
						</div>
						<div class="team-content">
							<h3 class="title"> <a href="messagesend.jsp?fid=<%=rs.getString("fid")%>#team">
                                                                <%=rs.getString("fid")%>&nbsp;&nbsp; <%=rs.getString("usrname")%></a></h3>
