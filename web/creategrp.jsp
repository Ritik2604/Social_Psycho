	...
	<div id="groups" class="section wb">
			...
			<div class="section-title text-center">
				...
				<div class="col-md-12">
                        ...
                        <div id="message"></div>
                        <br><br<br>
                                               <form  action="creategrp2" name="f1" onsubmit="return check(f1)" method="post" novalidate="novalidate">
                                                   <br><br>
								<div class="col-md-6">
									<div class="form-group" style="left:50%">
                                                                            <input  name="Text1"class="form-control" id="a" placeholder="Group Name" required="required" data-validation-required-message="Please enter a group name.">                                                         
