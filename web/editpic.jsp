...
<body id="page-top" class="politics_version">
	...
	<section id="home" class="main-banner parallaxie" style="background: url('<%=session.getAttribute("img")%>')">
		<div class="heading">
			...
			<div class="btn-ber">
                             <form method="post"  enctype="multipart/form-data"action="editpic2">
                                 <input  class="sim-btn hvr-bounce-to-top" name="File1" type="file"><br>
                                 
                                 <button class="sim-btn hvr-bounce-to-top" name="Submit1" type="submit" >Upload</button>
                             </form>
                        </div>
