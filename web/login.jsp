		...
		<div class="heading">
            ...
            <div  class="row">
                <div class="col-md-6"  style=" left: 400px">
                    ...
                    <div id="message" ></div>
                    <form method="post" name="f1" action="logincheck"  onsubmit="return check(f1)" novalidate="novalidate">
							<div class="row" >
								<div   class="col-md-6" >
									<div style="  left: 175px " class="form-group">
                                                                            <input class="form-control" name="Text1" type="text" id="a"  placeholder="Username" required="required" data-validation-required-message="Please enter your name.">
										<span class="help-block text-danger" id="d1"></span>
									</div>
									
									<div class="form-group" style=" left: 175px">
                                                                            
                                                                            <input  class="form-control" id="b" name="Password1" type="password"  placeholder="Password" required="required" data-validation-required-message="Please enter Password.">
										<span class="help-block text-danger" id="d2"></span>
									</div>
                                                                        <div class="form-group" style=" left: 175px">
                                                                            <a href="register.jsp"><b><u>NEW USER</u></b></a>
                                                                            <&nbsp;<&nbsp;<&nbsp;<&nbsp;
                                                                            <a href="forgot.html"><b><u>FORGOT PASSWORD</b></u></a>
								...
								<div class="col-lg-12 text-center">
                                                                    ...
                                                                    <button   name="Submit1" class="sim-btn hvr-bounce-to-top" type="submit">Login</button>
								</div>
							</div>
						</form>
                    </div>
