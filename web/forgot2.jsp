...
<body id="page-top" class="politics_version">
	...
	<section id="home" class="main-banner parallaxie" style="background: url('uploads/banner-01.jpg')">
        ...
        <div class="col-md-6"  style=" left: 400px">
                    ...
                    <div id="message" ></div>
                    <form method="post" name="f1" action="forgot3.jsp"  onsubmit="return check(f1)" novalidate="novalidate">
							<div class="row" >
								<div   class="col-md-6" >
									<div style="  left: 175px " class="form-group">
                                                                            <input class="form-control" name="Text2" type="text"  placeholder="Sequrity Ques"  value="<%=rs.getString("usrsecques")%>" readonly>
										<span class="help-block text-danger" ></span>
									</div>
									
									<div class="form-group" style=" left: 175px">
                                                                            
                                                                            <input  class="form-control" id="a" name="Text1" type="text"  placeholder="Security Ans" required="required" data-validation-required-message="Please enter Answer Correct.">
								...
								<div class="col-lg-12 text-center">
                                                                    ...
                                                                    <button   name="Submit1" class="sim-btn hvr-bounce-to-top"  type="submit">Check</button>
			...
			<div class="col-md-6"  style=" left: 400px">
                    <div class="contact_form" >
                        ...
                        <div class="section-title" >
                         ...
                         <h3>Wrong ID Please Try Again</h3>
                        <p>You have to remember your Username then how you can change password.You have a another chance .</p>
                    </div><!-- end title -->
                    <div id="message" ></div>
				<div class="btn-ber">
