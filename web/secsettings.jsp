                ...
                <div class="col-md-6"  style=" left: 400px">
                    <div class="contact_form" >
                        <div class="section-title" >
                         <h3>Change Security Settings</h3>
                        <p>Remember your Answer because when you forgot your password it is the only thing to change it.</p>
                    </div><!-- end title -->
                    <div id="message" ></div>
                    <form method="post" name="f1" action="secsettings2.jsp"  onsubmit="return check(f1)" novalidate="novalidate">
							<div class="row" >
								<div   class="col-md-6" >
									<div style="  left: 175px " class="form-group">
                                                                            <input class="form-control" name="Password1" type="password" id="b"  placeholder=" Password" required="required" data-validation-required-message="Please enter your  password.">
										<span class="help-block text-danger" id="d2"></span>
									</div>
									
									<div class="form-group" style="  left: 175px ">
                                                                    ...
                                                                    <div class="form-group" style=" left: 175px">
                                                                            ...
                                                                            <input  class="form-control" id="a" name="Text2" type="text"  placeholder="Sequrity Answer" required="required" data-validation-required-message="Please enter new Password again.">
